...
### Study Activity Show Index `/study_activities/:id`
#### Purpose
...
### Study Activities Launch Index `/study_activities/:id/launch`
#### Purpose
...
- Paginated Word List
    ...
    - Clicking the japanese word goes to the word show page
#### Needed API Endpoints
GET /api/words
